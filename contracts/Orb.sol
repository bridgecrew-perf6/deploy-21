...
contract Freezable is KIP7, Ownable {
    ...
    function transfer(address to, uint256 value) public notFrozenAccount returns (bool) {
        return super.transfer(to, value);
    }

    function transferFrom(address from, address to, uint256 value) public notFrozenAccount returns (bool) {
        return super.transferFrom(from, to, value);
    }

    function approve(address spender, uint256 value) public notFrozenAccount returns (bool) {
        return super.approve(spender, value);
    }
}

contract Orb is KIP7Burnable, KIP7Pausable, KIP7Metadata, Ownable, Freezable {
    constructor() public KIP7Metadata("KlayCity", "ORB", 18) {
